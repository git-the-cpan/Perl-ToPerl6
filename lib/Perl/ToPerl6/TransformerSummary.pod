...
Format my(), our(), print() [Default severity 5]
...
=head2 L<Instances::Creation|Perl::ToPerl6::Transformer::Instances::Creation>
...
=head2 L<Pragmas::FormatConstants|Perl::ToPerl6::Transformer::Pragmas::FormatConstants>
